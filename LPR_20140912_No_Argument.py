...
if maxima_calc==1:
   str = 'Frequency Mod Maxima Max (PPM) (100MHz), ' + \
         '%.2f' % ((lpr1.maxima_max-100)/100*MHz)
   resultFile.write(str + '\n')
   print(str)

   str = 'Frequency Mod Maxima Mean (PPM) (100MHz), ' + \
         '%.2f' % ((lpr1.maxima_mean-100)/100*MHz)
   resultFile.write(str + '\n')
   print(str)

   str = 'Frequency Mod Maxima Min (PPM) (100MHz), ' + \
         '%.2f' % ((lpr1.maxima_min-100)/100*MHz)
   resultFile.write(str + '\n')
   print(str)
...
for spec in ECspecList:
    if spec == PCIe_1:
         ...
         str = PCIe_2_SRIS.name + ' : RMS   (ps),' + '%3.3f' % (PCIe_2_SRIS_WORST_rms/ps)
         resultFile.write(str + '\n')
         print(str)
         ...
         str = PCIe_3_SRIS.name + ' : RMS   (ps),' + '%3.3f' % (PCIe_3_SRIS_WORST_rms/ps)
         resultFile.write(str + '\n')
         print(str)
